...
{
    public record GetEmployeeDataByAccountTreeIdQuery(int employeeId, int accountTreeId, DateTime peekDate) : IQuery<EmployeeDataInfoDto>;
    public class GetEmployeeDataByAccountTreeIdQueryHandler : IQueryHandler<GetEmployeeDataByAccountTreeIdQuery, EmployeeDataInfoDto>
    {
        private readonly IUOW _uow;
        private readonly IMapper _mapper;
        public GetEmployeeDataByAccountTreeIdQueryHandler(IUOW uow, IMapper mapper)
        {
            this._mapper = mapper;
            this._uow = uow;

        }
        public async Task<Result<EmployeeDataInfoDto>> Handle(GetEmployeeDataByAccountTreeIdQuery request, CancellationToken cancellationToken)
        {
